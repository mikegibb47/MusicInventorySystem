...
public class InventorySystem {
    ...
    //////////////////////////
    /**
     * Creates an inventory system. WARNING: USING THIS CONSTRUCTOR MAKES THE
     * OBJECT CONTAIN INACCURATE DUMMY DATA. THIS CONSTRUCTOR IS FOR TESTING
     * PURPOSES ONLY.
     *
     * @author Erica Garand
     ...
     *
     * @author Erica Garand
     * @param users - the list of users that this inventory system will keep
     * track of. Should contain at least one admin.
     * @param instruments - the list of instruments that this inventory system
     * will keep track of.
     */
    ...
    /**
     * Allows an admin profile to add or remove admin privileges to any account
     * except for itself.
     *
     * @author Erica Garand
     * @param u - The account to change the admin status of.
     * @param a - the status to change the account's status to. True if they
     * should be an admin, false if they should not be an admin.
     */
     ...
     *
     * @author Erica Garand
     * @param a - The instrument to add to the list. Should be newly created, as
     * key components of Insrument objects are unchangeable once they're created.
     */
     ...
     *
     * @author Erica Garand
     * @param barcode - the id number or barcode of the instrument to be removed
     * from memory.
     */
     ...
     *
     * @author Erica Garand
     * @param barcode - the id number or barcode of the instrument to be marked
     * as out for service.
     */
     ...
     *
     * @author Erica Garand
     * @param barcode - the id number or barcode of the instrument to be signed
     * back in
     */
     ...
     * the target. NOTE: You must cast this parameter as a (List) for it to work!
     */
